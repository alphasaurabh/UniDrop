...
export function ThemeToggle({ className, showLabel = false }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "group inline-flex items-center gap-2 rounded-2xl border border-border/70 bg-card/88 px-3 py-2 text-sm font-medium shadow-soft backdrop-blur-sm",
        "transition-[background-color,border-color,box-shadow,color,opacity,transform] duration-150 ease-out hover:border-primary/30 hover:shadow-soft md:hover:-translate-y-px active:scale-[0.98]",
